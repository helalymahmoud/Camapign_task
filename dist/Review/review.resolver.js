...
const create_review_dto_1 = require("./input/create-review.dto");
const review_type_1 = require("./input/review.type");
...
__decorate([
    ...
    __param(1, (0, graphql_1.Args)('reviewData')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReviewResolver.prototype, "getAllReviews", null);
__decorate([
    (0, graphql_1.Query)(() => [review_type_1.ReviewType]),
    __param(0, (0, graphql_1.Args)('userId')),
    __metadata("design:type", Function),
